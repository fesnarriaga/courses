...
namespace CompleteApp.Business.Validators
{
    public class CpfValidator
    {
        public const int DocumentSize = 11;
        ...
        {
            return valor.Length == DocumentSize;
        }
        ...
        {
            var number = valor.Substring(0, DocumentSize - 2);
            ...
            return string.Concat(firstDigit, secondDigit) == valor.Substring(DocumentSize - 2, 2);
        }
    }

    public class CnpjValidator
    {
        public const int DocumentSize = 14;
